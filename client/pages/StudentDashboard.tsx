  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900">
      ...
      <div className="container mx-auto px-6 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Welcome back, Sarah!</h1>
          <p className="text-slate-600 dark:text-slate-300">Manage your certificates and track verification requests</p>
        </div>
                    ...
                    <div key={cert.id} className="border border-slate-200 rounded-lg p-4 bg-white/50">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-slate-600 mb-2">{cert.institution}</p>
                        ...
                        <div className="flex items-center gap-2">
                          <Badge 
                            ...
                            className={cert.status === "verified" ? "bg-green-100 text-green-700 border-green-200" : ""}
                          >
                ...
                <div className="space-y-4">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="border-l-2 border-blue-200 pl-4 pb-4">
                      ...
                      <p className="text-xs text-slate-600 mb-1">{activity.entity}</p>
                      <p className="text-xs text-slate-500">{activity.certificate}</p>
                    </div>
                  ))}
                </div>
